          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="hidden md:flex space-x-8">
                {["hero", "about", "projects", "experience", "contact"].map(
                  (section) => (
                    <button
                      key={section}
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
                ...
                with modern technologies. Experienced in React.js, JavaScript
                ES6+, and full-stack development.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  I'm a passionate Frontend Developer and Full Stack Engineer
                  with experience in building dynamic, responsive web
                  applications. I hold a Bachelor's degree in Information
                  Technology from DY Patil College of Engineering with a CGPA of
                  8.06. I love creating seamless user experiences and solving
        ...
        <footer className="py-12 px-4 bg-gray-900 text-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8">
              Frontend Developer & Full Stack Engineer • Building innovative web
              solutions
            </p>
